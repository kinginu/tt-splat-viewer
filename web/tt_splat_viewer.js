...
export function set_canvas_size(width, height) {
    wasm.set_canvas_size(width, height);
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000004: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("Array<any>"), NamedExternref("ResizeObserver")], shim_idx: 112, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
